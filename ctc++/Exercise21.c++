...
public:
    ...
    Node<T>* appendLists(SingleLinkedList<T>& list2) {
        Node<T>* result = nullptr;
        Node<T>** lastPtrRef = &result;
...
int main() {
    SingleLinkedList<int> *singleLinkedList1 = new SingleLinkedList<int>();
    ...
    SingleLinkedList<int> *singleLinkedList2 = new SingleLinkedList<int>();;
    ...
    //(*singleLinkedList2).addNodeDescending(3);
